"""Formato estándar de error de la API general (misma convención que la Consola:
...
def unauthorized(message: str = "Tu sesión expiró. Vuelve a iniciar sesión.",
                 code: str = "UNAUTHORIZED") -> ApiError:
    return ApiError(401, code, message)


def forbidden(message: str = "No tienes permiso para esta acción.") -> ApiError:
